    ...
    return (
        <div className='bg-inito-light-blue  pt-10'>
            <div className='mx-auto flex  lg:max-w-6xl items-center justify-between lg:p-6 lg:px-8 flex-col pb-10 '>
                ...
                <div className=' max-w-xs md:max-w-4xl w-full border-gray-600 rounded-md bg-white shadow-xl -mt-28 md:-mt-40 '>
                    <div className='relative flex justify-end'> <img src='https://cdn.inito.com/inito_website/blue_calendar.png' className='absolute w-24 h-24 -top-8 -right-6 ' />

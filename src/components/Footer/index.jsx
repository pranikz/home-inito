...
const navigation = {
  ...
  row_three: [
    ...
    { name: '+91 974 293 19 31', href: '#' },
    { name: 'help@inito.com', href: '#' },
    {
      name: '355 Bryant Street, Suite 403, San Francisco 94017'
      , href: '#'
    }
  ],
  social: [
...
export default function index() {
  return (
    <footer aria-labelledby="footer-heading" className="bg-inito-footer ">
      <h2 id="footer-heading" className="sr-only">
        Footer
      </h2>
      <div className="mx-auto max-w-6xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.row_one.map((item) => (
                    <li key={item.name}>
